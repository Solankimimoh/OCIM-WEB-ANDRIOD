...
<body>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">REVIEW</strong>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var ref = firebase.database().ref().child("review");
            ...
            ref.once('value', function(snapshot) {
                snapshot.forEach(function(childSnapshot) {
                    ...
                    if (childData.hospitalUid == hospitalUID) {
                        mytable.insertRow(length).outerHTML = `<td>${childData.userEmail}</td><td>${childData.title}</td>
