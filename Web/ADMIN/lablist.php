...
<body>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Laboratory</strong>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            var ref = firebase.database().ref().child("laboratory");
...
<td><button onclick='test("${childSnapshot.key}")' class='btn btn-primary'>APPROVE</button></td>`;
        ...
        function test(e) {
            ...
            var ref = firebase.database().ref().child("laboratory").child(e).child("verify").set(true);
