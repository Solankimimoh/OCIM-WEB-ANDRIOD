...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            var ref = firebase.database().ref().child("medical");
...
<td><button onclick='test("${childSnapshot.key}")' class='btn btn-primary'>APPROVE</button></td>`;
        ...
        function test(e) {
            ...
            var ref = firebase.database().ref().child("medical").child(e).child("verify").set(true);
           alert("approved Successfully");
            
                        window.location.href="medicallist.php";
